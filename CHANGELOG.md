# ChangeLog of insights-core.egg
# - For changelog of insights-core.rpm, see the insights-core.spec
...
- fix(data-processing): fix unpredictable behavior of --context ([PR 4740](https://github.com/RedHatInsights/insights-core/pull/4740))
- chore: remove planned deprecations for v3.7.0 ([PR 4699](https://github.com/RedHatInsights/insights-core/pull/4699))
- fix(rpm-build): add 'BuildRequires: pkgconfig(systemd)' back for insights-core-selinux ([PR 4749](https://github.com/RedHatInsights/insights-core/pull/4749))
- feat: New spec "/etc/modules-load.d/*.conf" and its parser ([PR 4733](https://github.com/RedHatInsights/insights-core/pull/4733))
- chore(spec): New spec "podman system info --json" for data analysis ([PR 4727](https://github.com/RedHatInsights/insights-core/pull/4727))
- chore(manifests): remove/merge remained useless components ([PR 4747](https://github.com/RedHatInsights/insights-core/pull/4747))
- chore(manifests): use the base module instead of component ([PR 4730](https://github.com/RedHatInsights/insights-core/pull/4730))
- chore: add egg_release back to collection with a condition ([PR 4729](https://github.com/RedHatInsights/insights-core/pull/4729))
- fix(build): prepare the filters.yaml before setting up  ([PR 4745](https://github.com/RedHatInsights/insights-core/pull/4745))
- chore(spec): update SELinux relevant specs ([PR 4728](https://github.com/RedHatInsights/insights-core/pull/4728))
- chore: remove unused lines from PR template ([PR 4725](https://github.com/RedHatInsights/insights-core/pull/4725))
- chore(test): don't pass context when root is passed to initialize_broker ([PR 4720](https://github.com/RedHatInsights/insights-core/pull/4720))
- chore: update PR template and remove RPM/Egg delivery guide ([PR 4723](https://github.com/RedHatInsights/insights-core/pull/4723))
- feat: add CoreEgg/CoreRpm to identify current collector ([PR 4724](https://github.com/RedHatInsights/insights-core/pull/4724))
...
- feat: New parser MdatpManaged and the spec ([PR 4569](https://github.com/RedHatInsights/insights-core/pull/4569))
- fix(doc): add required configuration for readthedocs ([PR 4568](https://github.com/RedHatInsights/insights-core/pull/4568))
- chore(doc): update the guide steps for PR to 3.0_egg ([PR 4567](https://github.com/RedHatInsights/insights-core/pull/4567))
- fix: handle error lines of spec grubby_default_index ([PR 4564](https://github.com/RedHatInsights/insights-core/pull/4564))
- fix: Skip RpmVPackage only when no error and no installed ([PR 4560](https://github.com/RedHatInsights/insights-core/pull/4560))
- feat: Add spec and parser for compliance_policies_enabled ([PR 4559](https://github.com/RedHatInsights/insights-core/pull/4559))
- fix: revert the ls specs removed by mistake ([PR 4555](https://github.com/RedHatInsights/insights-core/pull/4555))
- fix: exclude irrelevant logrotate configuration files ([PR 4556](https://github.com/RedHatInsights/insights-core/pull/4556))
- doc: add RPM delivery notes to contributing ([PR 4549](https://github.com/RedHatInsights/insights-core/pull/4549))
- fix: don't immediately exit collection when inventory_id is unavailable ([PR 4543](https://github.com/RedHatInsights/insights-core/pull/4543))
- chore: sync the tito required file to master ([PR 4548](https://github.com/RedHatInsights/insights-core/pull/4548))
