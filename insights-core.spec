...
- fix: don't collect teamd specs when SELinux is enabled (#4734)
  (xiangceliu@redhat.com)
- chore(build): add build_client_egg script back to master (#4722)
  (xiangceliu@redhat.com)
...
- fix: traceback info in metadata JSON of filterable specs (#4694)
  (xiangceliu@redhat.com)
- fix(spec): stop collecting sealert on RHEL 9 and older (#4698)
  (xiangceliu@redhat.com)
- fix(doc): avoid too extensive cross-ref check (#4695) (xiangceliu@redhat.com)
...
- fix: error msg for compliance apiv2 assign/unassign (#4328)
  (xiangceliu@redhat.com)
- chore: sort out exceptions (#4327) (xiangceliu@redhat.com)
- chore: do not collect chkconfig on RHEL 7+ (#4326) (xiangceliu@redhat.com)
